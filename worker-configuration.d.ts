/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce953d6ebe323ef5eb168bde004fd2e3)
// Runtime types generated with workerd@1.20260415.1 2026-04-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/custom-entry");
		durableNamespaces: "WebSocketChat";
	}
	interface Env {
		APP_QUEUE: Queue;
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		WEBSOCKET_CHAT: DurableObjectNamespace<import("./worker/custom-entry").WebSocketChat>;
	}
}
